...
public class CreateRoundActivity extends Activity implements View.OnClickListener{
    ...
    private static final String TAG = CreateRoundActivity.class.getSimpleName();
    ...
    private void setDateTimeField() {
        inputDate.setOnClickListener((View.OnClickListener) this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(), "Round successfully created", Toast.LENGTH_LONG).show();
                    } else {
